...
public class ContactMain {
	public static void main(String[] args) {
		...
		// 인스턴스 생성 => new 클래스 이름-> 클래스() 생성자 호출
		Contact contact1 = new Contact("손흥민", "010-0000-0000", "son@email.com", "London", "2000-10-22", "친구");
		...
		contact2.setBirthday("2000-10-22"); //나중에 문자열을 -나/기준으로 split으로 자를 수도 있음
