...
public class DeptDao {
	...
	// 부서 정보를 검색 메소드 : select -> Connection을 전달받고, Dept
	...
	// 부서 정보를 입력 메소드 : insert -> Connection을 전달받고, Dept 객체를 전달 받아서 입력
	public int insertDept(Connection conn, Dept dept) {
		...
		try {
			...
			pstmt.setString(3, dept.getDname());
	...
	// 부서 정보를 삭제하는 메소드 : delete -> Connection을 전달받고, 부서번호(pk)를 전달 받아 삭제
