...
public class SortPrinting {
	...
	public static void printNameIn_N_Row(VO_Sales[][] testArr, int N, int index) {
		int countOdd = 0;
	...
	// 배너 출력(결제 / 상품이름 / 타입 ...)
	public static void printBanner(String indicator) {
		...
		System.out.println(SortPrinting.ROW);
		System.out.println(SortPrinting.SPACE);
		SortPrinting.centerAlign("■■■■■■■■ ".concat(indicator).concat(" ■■■■■■■■"));
		System.out.println(SortPrinting.SPACE);
		System.out.println(SortPrinting.ROW);
		System.out.println(SortPrinting.SPACE);
	}
