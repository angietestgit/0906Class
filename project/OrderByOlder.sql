...
ho_date varchar2(40) default '2021/11/14' 
);
...
select sum(s_price) from sales natural join hamorder where saleDate = '2021/11/14';
select s_name from sales natural join Hamorder where Hamorder.ageType = 'TheOld';
